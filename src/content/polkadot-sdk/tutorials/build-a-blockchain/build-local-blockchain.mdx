...
<Aside type="info" title="Prerequisites">
...
<Aside type="success" title="Tutorial objectives">
...
1. Start the front-end template by running the following command:
   ...
   ![Front-end template top section](./media/blockchain-top.png)
   ...
   ![Predefined accounts and balances](./media/balances.png)
...
1. In the Balances table, notice the predefined accounts—such as dave—that have no funds associated with them.
   ...
   ![Locate an account with zero funds](./media/dave-account.png)
...
1. Specify at least **1000000000000** as the amount to transfer, then click **Submit**.
   ...
   ![Transfer funds to an account](./media/transfer-filled.png)

1. Notice that the values in Balances table is updated with the transfer.

   ![Updated balance displayed](./media/balance-result.png)
...
1. Check the **Events** component to see events related to the transfer you just completed.
   ...
   ![Events recorded as results from asynchronous operations](./media/event-panel.png)
