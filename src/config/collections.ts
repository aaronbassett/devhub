...
import { ContentCollectionsMetaSchema } from "@schemas/collections/data/content-collections-meta"
...
export const ContentCollections: Record<string, ContentCollection> = {
  "polkadot-sdk": {
    ...
    description:
      "Comprehensive tools for building and integrating with the Polkadot blockchain ecosystem.",
    slug: "polkadot-sdk",
  ...
  "smart-contracts": {
    ...
    description:
      "Efficient and secure development framework for smart contracts on the Polkadot network.",
  ...
  dapps: {
    ...
    description:
      "Build resilient and decentralized applications which utilize all the features of the Polkadot ecosystem.",
    slug: "dapps",
...
export const DataCollections: Record<string, DataCollection> = {
  contentCollectionsMeta: {
    name: "content-collections-meta",
    label: "Content Collections Meta",
    schema: ContentCollectionsMetaSchema,
  },
  personas: {
    name: "personas",
    label: "Personas",
